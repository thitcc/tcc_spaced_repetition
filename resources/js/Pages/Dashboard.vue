...
onMounted(() => {
  const storedDirection = sessionStorage.getItem("sortDirection");
  if (storedDirection) {
...
<template>
  ...
  <AuthenticatedLayout :user="props.user">
    ...
    <div class="py-12">
      <div class="max-w-6xl mx-auto flex justify-end px-4 mb-4">
        <button
          class="sortBy py-2 px-4 text-black font-semibold rounded-lg shadow-md hover:text-black focus:outline-none"
          @click="toggleSort"
        >
          Ordenar
        </button>
          ...
          <div class="p-6 text-gray-900">
            <div v-if="props.courses.length" class="grid md:grid-cols-3 gap-4">
              <div
                ...
                :key="course.id"
                class="cursor-pointer bg-gray-100 hover:bg-gray-200 rounded-lg p-4 shadow transition duration-300 ease-in-out"
        ...
        <div class="mt-3 text-center">
          ...
          <form @submit.prevent="createCourse">
            <input
              ...
              class="mt-2 px-3 py-2 border rounded-md w-full"
              required
            />
